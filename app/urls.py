...
from .views import landingview, productlistview, supplierlistview, addsupplier, \
    addproduct, deleteproduct, confirmdeleteproduct, deletesupplier, confirmdeletesupplier, \
    edit_product_get, edit_product_post, edit_supplier_get, edit_supplier_post, searchsuppliers, products_filtered
